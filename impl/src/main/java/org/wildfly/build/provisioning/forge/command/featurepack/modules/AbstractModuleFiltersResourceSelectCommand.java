...
/**
 * Abstract command that is only enabled if the selected name is a {@link org.wildfly.build.provisioning.forge.resource.FeaturePackResource} which contains module filters.
 * @author Eduardo Martins
 */
public abstract class AbstractModuleFiltersResourceSelectCommand extends AbstractFeaturePackResourceSelectedCommand {
